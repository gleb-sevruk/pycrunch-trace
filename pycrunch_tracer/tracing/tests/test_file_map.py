from pycrunch_tracer.events.method_enter import MethodEnterEvent, ExecutionCursor, StackFrame, MethodExitEvent
...
def test_a():
    from pycrunch_tracer.client.networking.client_trace_introspection import ClientTraceIntrospection
